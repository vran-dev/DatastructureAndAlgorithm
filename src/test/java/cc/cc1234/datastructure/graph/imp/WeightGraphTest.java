...
public class WeightGraphTest {
	...
	public void testDenseWeightGraph() {
		...
		assertSame(1, dense.weight(0, 1));
		assertSame(1, dense.weight(1, 0));
		assertSame(16, dense.weight(7, 9));
		assertSame(16, dense.weight(9, 7));
		assertSame(-1, dense.weight(1, 9));
		assertSame(-1, dense.weight(9, 1));
	}
	...
	public void testSparseWeightGraph() {
		...
		assertSame(1, sparse.weight(0, 1));
		assertSame(1, sparse.weight(1, 0));
		assertSame(16, sparse.weight(7, 9));
		assertSame(16, sparse.weight(9, 7));
		assertSame(-1, sparse.weight(1, 9));
		assertSame(-1, sparse.weight(9, 1));
	}
}
